...
struct rb_node *rb_search(struct rb_node *root, const void *key, rb_key_comp_fptr rb_key_comp);
...
struct rb_node *rb_insert(struct rb_node *root, struct rb_node *node, rb_key_comp_fptr rb_key_comp);
