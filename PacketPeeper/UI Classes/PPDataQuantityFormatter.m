      ...
      errorDescription:(NSString**)errorString
{
    ...
    if (bytes != 0)
    {
        if (strcasecmp(endptr, "GB") == 0 ||
            strcasecmp(endptr, "gigabytes") == 0)
        {
            ...
            strcasecmp(endptr, "MB") == 0 || strcasecmp(endptr, "M") == 0 ||
            strcasecmp(endptr, "megabytes") == 0)
        {
            ...
            strcasecmp(endptr, "KB") == 0 || strcasecmp(endptr, "K") == 0 ||
            strcasecmp(endptr, "kilobytes") == 0)
        {
